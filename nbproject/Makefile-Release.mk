...
${OBJECTDIR}/chat.o: chat.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/chat.o chat.c

${OBJECTDIR}/distributed/distributed.o: distributed/distributed.c 
	${MKDIR} -p ${OBJECTDIR}/distributed
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributed/distributed.o distributed/distributed.c

${OBJECTDIR}/distributed/merge.o: distributed/merge.c 
	${MKDIR} -p ${OBJECTDIR}/distributed
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributed/merge.o distributed/merge.c

${OBJECTDIR}/distributed/protocol.o: distributed/protocol.c 
	${MKDIR} -p ${OBJECTDIR}/distributed
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distributed/protocol.o distributed/protocol.c

${OBJECTDIR}/fbook.o: fbook.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fbook.o fbook.c

${OBJECTDIR}/gtp.o: gtp.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gtp.o gtp.c

${OBJECTDIR}/joseki/base.o: joseki/base.c 
	${MKDIR} -p ${OBJECTDIR}/joseki
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/joseki/base.o joseki/base.c

${OBJECTDIR}/joseki/joseki.o: joseki/joseki.c 
	${MKDIR} -p ${OBJECTDIR}/joseki
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/joseki/joseki.o joseki/joseki.c

${OBJECTDIR}/montecarlo/montecarlo.o: montecarlo/montecarlo.c 
	${MKDIR} -p ${OBJECTDIR}/montecarlo
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/montecarlo/montecarlo.o montecarlo/montecarlo.c
...
${OBJECTDIR}/ownermap.o: ownermap.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ownermap.o ownermap.c

${OBJECTDIR}/pachi.o: pachi.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pachi.o pachi.c

${OBJECTDIR}/pattern.o: pattern.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pattern.o pattern.c

${OBJECTDIR}/pattern3.o: pattern3.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pattern3.o pattern3.c

${OBJECTDIR}/patternplay/patternplay.o: patternplay/patternplay.c 
	${MKDIR} -p ${OBJECTDIR}/patternplay
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/patternplay/patternplay.o patternplay/patternplay.c

${OBJECTDIR}/patternprob.o: patternprob.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/patternprob.o patternprob.c

${OBJECTDIR}/patternscan/patternscan.o: patternscan/patternscan.c 
	${MKDIR} -p ${OBJECTDIR}/patternscan
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/patternscan/patternscan.o patternscan/patternscan.c

${OBJECTDIR}/patternsp.o: patternsp.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/patternsp.o patternsp.c

${OBJECTDIR}/playout.o: playout.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/playout.o playout.c

${OBJECTDIR}/playout/light.o: playout/light.c 
	${MKDIR} -p ${OBJECTDIR}/playout
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/playout/light.o playout/light.c

${OBJECTDIR}/playout/moggy.o: playout/moggy.c 
	${MKDIR} -p ${OBJECTDIR}/playout
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/playout/moggy.o playout/moggy.c

${OBJECTDIR}/probdist.o: probdist.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/probdist.o probdist.c
...
${OBJECTDIR}/random/random.o: random/random.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/random/random.o random/random.c

${OBJECTDIR}/replay/replay.o: replay/replay.c 
	${MKDIR} -p ${OBJECTDIR}/replay
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/replay/replay.o replay/replay.c

${OBJECTDIR}/stone.o: stone.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stone.o stone.c

${OBJECTDIR}/t-unit/test.o: t-unit/test.c 
	${MKDIR} -p ${OBJECTDIR}/t-unit
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/t-unit/test.o t-unit/test.c

${OBJECTDIR}/tactics/1lib.o: tactics/1lib.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/1lib.o tactics/1lib.c

${OBJECTDIR}/tactics/2lib.o: tactics/2lib.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/2lib.o tactics/2lib.c

${OBJECTDIR}/tactics/ladder.o: tactics/ladder.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/ladder.o tactics/ladder.c

${OBJECTDIR}/tactics/nakade.o: tactics/nakade.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/nakade.o tactics/nakade.c

${OBJECTDIR}/tactics/nlib.o: tactics/nlib.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/nlib.o tactics/nlib.c

${OBJECTDIR}/tactics/selfatari.o: tactics/selfatari.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/selfatari.o tactics/selfatari.c

${OBJECTDIR}/tactics/util.o: tactics/util.c 
	${MKDIR} -p ${OBJECTDIR}/tactics
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tactics/util.o tactics/util.c

${OBJECTDIR}/timeinfo.o: timeinfo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/timeinfo.o timeinfo.c

${OBJECTDIR}/uct/dynkomi.o: uct/dynkomi.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/dynkomi.o uct/dynkomi.c

${OBJECTDIR}/uct/plugin/example.o: uct/plugin/example.c 
	${MKDIR} -p ${OBJECTDIR}/uct/plugin
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/plugin/example.o uct/plugin/example.c

${OBJECTDIR}/uct/plugin/wolf.o: uct/plugin/wolf.c 
	${MKDIR} -p ${OBJECTDIR}/uct/plugin
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/plugin/wolf.o uct/plugin/wolf.c

${OBJECTDIR}/uct/plugins.o: uct/plugins.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/plugins.o uct/plugins.c

${OBJECTDIR}/uct/policy/generic.o: uct/policy/generic.c 
	${MKDIR} -p ${OBJECTDIR}/uct/policy
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/policy/generic.o uct/policy/generic.c

${OBJECTDIR}/uct/policy/ucb1.o: uct/policy/ucb1.c 
	${MKDIR} -p ${OBJECTDIR}/uct/policy
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/policy/ucb1.o uct/policy/ucb1.c

${OBJECTDIR}/uct/policy/ucb1amaf.o: uct/policy/ucb1amaf.c 
	${MKDIR} -p ${OBJECTDIR}/uct/policy
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/policy/ucb1amaf.o uct/policy/ucb1amaf.c

${OBJECTDIR}/uct/prior.o: uct/prior.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/prior.o uct/prior.c

${OBJECTDIR}/uct/search.o: uct/search.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/search.o uct/search.c

${OBJECTDIR}/uct/slave.o: uct/slave.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/slave.o uct/slave.c

${OBJECTDIR}/uct/tree.o: uct/tree.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/tree.o uct/tree.c

${OBJECTDIR}/uct/uct.o: uct/uct.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/uct.o uct/uct.c

${OBJECTDIR}/uct/walk.o: uct/walk.c 
	${MKDIR} -p ${OBJECTDIR}/uct
	${RM} "$@.d"
	$(COMPILE.c) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/uct/walk.o uct/walk.c
